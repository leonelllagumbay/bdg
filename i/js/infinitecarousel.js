	...
	$.fn.extend({ 
		...
		var options = $.extend(defaults, options);
			...
			if(o.showControls)
			{
				...
				html = '<div id="btn_rt'+randID+'" style="position:absolute;right:2px;top:250px;cursor:pointer;border:none;width:66px;height:66px;background:url('+o.imagePath+'brbl.png) no-repeat 0 0"></div>';
				html += '<div id="btn_lt'+randID+'" style="position:absolute;left:2px;top:250px;cursor:pointer;border:none;width:66px;height:66px;background:url('+o.imagePath+'brbl.png) no-repeat -66px 0"></div>';
