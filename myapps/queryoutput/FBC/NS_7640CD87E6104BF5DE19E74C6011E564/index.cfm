...
<cfscript>
	...
	resp = appAccess.checkUserQueryAccess("7640CD87-E610-4BF5-DE19E74C6011E564","#session.userid#");
	if(resp == "false") {
...
<html>
	<head>
	    <title>All Actions - grid  dfgsd sdfg</title>
	    ...
	    <script type='text/javascript' src='../../../../scripts/ext-4.2.2/printer/Printer-all.js'></script>
