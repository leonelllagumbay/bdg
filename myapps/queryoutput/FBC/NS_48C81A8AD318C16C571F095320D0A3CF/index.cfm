...
<cfscript>
	...
	resp = appAccess.checkUserQueryAccess("48C81A8A-D318-C16C-571F095320D0A3CF","#session.userid#");
	if(resp == "false") {
...
<html>
	<head>
		...
		<cfoutput><link rel='stylesheet' type='text/css' href='../../../../scripts/extjs/resources/css/#session.companycsstheme#.css'></cfoutput>
