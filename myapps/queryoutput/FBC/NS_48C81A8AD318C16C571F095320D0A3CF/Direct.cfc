...
<cfcomponent name='Direct'>
	...
	<cfset variables.routerUrl = '#sProt##cgi.SERVER_NAME#:#cgi.SERVER_PORT#/myapps/queryoutput/FBC/NS_48C81A8AD318C16C571F095320D0A3CF/Router.cfm' />
	...
	<cffunction name='getAPIScript'>
		...
		<cfset jsonPacket['namespace'] = 'Ext.NS_48C81A8AD318C16C571F095320D0A3CF' />
