...
ExtDirect=true
{
	...
	Usql = "SELECT egintestquery.S1 AS 'Title', egintestquery.S2 AS 'Link', egintestquery.S3 AS 'Guid', egintestquery.S4 AS 'Category', egintestquery.S5 AS 'Pub Date', egintestquery.S6 AS 'Description'
	...
	for (var b = start+1; b <= start+limit; b++) {
    	tmpresult = StructNew();
    			...
    			tmpresult["egintestquery-S5"] = dquery["PUB DATE"][b];
