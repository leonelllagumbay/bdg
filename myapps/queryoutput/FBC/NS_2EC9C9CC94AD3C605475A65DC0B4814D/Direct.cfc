...
<cfcomponent name='Direct'>
	...
	<cfset variables.routerUrl = '#sProt##cgi.SERVER_NAME#:#cgi.SERVER_PORT#/myapps/queryoutput/FBC/NS_2EC9C9CC94AD3C605475A65DC0B4814D/Router.cfm' />
	...
	<cffunction name='getAPIScript'>
		...
		<cfset jsonPacket['namespace'] = 'Ext.NS_2EC9C9CC94AD3C605475A65DC0B4814D' />
