...
<cfcomponent name='Direct'>
	...
	<cfset variables.routerUrl = '#sProt##cgi.SERVER_NAME#:#cgi.SERVER_PORT#/myapps/queryoutput/FBC/NS_48E5A919C621E9A46869283C82751148/Router.cfm' />
	...
	<cffunction name='getAPIScript'>
		...
		<cfset jsonPacket['namespace'] = 'Ext.NS_48E5A919C621E9A46869283C82751148' />
