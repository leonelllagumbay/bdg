...
<cfcomponent name='Direct'>
	...
	<cfset variables.routerUrl = '#sProt##cgi.SERVER_NAME#:#cgi.SERVER_PORT#/myapps/queryoutput/FBC/NS_F6F7A8DDCA320C91EA5C9D59DBEAD714/Router.cfm' />
	...
	<cffunction name='getAPIScript'>
		...
		<cfset jsonPacket['namespace'] = 'Ext.NS_F6F7A8DDCA320C91EA5C9D59DBEAD714' />
