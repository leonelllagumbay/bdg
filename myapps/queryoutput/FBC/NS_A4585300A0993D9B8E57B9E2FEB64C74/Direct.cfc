...
<cfcomponent name='Direct'>
	...
	<cfset variables.routerUrl = '#sProt##cgi.SERVER_NAME#:#cgi.SERVER_PORT#/myapps/queryoutput/FBC/NS_A4585300A0993D9B8E57B9E2FEB64C74/Router.cfm' />
	...
	<cffunction name='getAPIScript'>
		...
		<cfset jsonPacket['namespace'] = 'Ext.NS_A4585300A0993D9B8E57B9E2FEB64C74' />
