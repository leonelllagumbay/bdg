...
Ext.application({
	...
	name: 'Form',
	controllers: ['queryoutput.FBC.NS_8042B445DA9830A56B12EF3924EFF604.Controller'],
	appFolder: '../../../../app',
	init: function(app) {
		Ext.direct.Manager.addProvider(Ext.NS_8042B445DA9830A56B12EF3924EFF604.APIDesc);
		GLOBAL_VARS_DIRECT = {
			USERID : 'ADMIN',
			PID : 'PI0',
	...
	launch: function(){
		...
		Ext.create('Ext.container.Viewport', {
			...
			items: [{
				xtype: 'NS_8042B445DA9830A56B12EF3924EFF604'
			}],
