		...
		Ext.direct.Manager.addProvider(Ext.NS_48C9ECD6A7DA0635AC7384C754FAD8CD.APIDesc)
			...
			launch: function(){
				...
				Ext.create('Ext.panel.Panel', {
				 	title: 'Liveboard White (Combination)',  
