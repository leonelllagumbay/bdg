		...
		<cfcomponent name='Direct'>
			...
			<cfset variables.routerUrl = '#sProt##cgi.SERVER_NAME#:#cgi.SERVER_PORT#/myapps/dashboard/FBC/LB_835691A8CDD1D64D9D5D0C9610E59C21/Router.cfm' />
			...
			<cffunction name='getAPIScript'>
				...
				<cfset jsonPacket['namespace'] = 'Ext.LB_835691A8CDD1D64D9D5D0C9610E59C21' />
