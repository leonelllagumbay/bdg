		...
		<cfcomponent name='Direct'>
			...
			<cfset variables.routerUrl = '#sProt##cgi.SERVER_NAME#:#cgi.SERVER_PORT#/myapps/dashboard/FBC/LB_53DBEE0CBC597220C154F82F3569438E/Router.cfm' />
			...
			<cffunction name='getAPIScript'>
				...
				<cfset jsonPacket['namespace'] = 'Ext.LB_53DBEE0CBC597220C154F82F3569438E' />
