		...
		<cfcomponent name='Direct'>
			...
			<cfset variables.routerUrl = '#sProt##cgi.SERVER_NAME#:#cgi.SERVER_PORT#/myapps/dashboard/FBC/LB_47819023E09D8001CA86F5D183B3ADA8/Router.cfm' />
			...
			<cffunction name='getAPIScript'>
				...
				<cfset jsonPacket['namespace'] = 'Ext.LB_47819023E09D8001CA86F5D183B3ADA8' />
