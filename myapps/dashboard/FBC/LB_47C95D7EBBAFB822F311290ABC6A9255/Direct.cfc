		...
		<cfcomponent name='Direct'>
			...
			<cfset variables.routerUrl = '#sProt##cgi.SERVER_NAME#:#cgi.SERVER_PORT#/myapps/dashboard/FBC/LB_47C95D7EBBAFB822F311290ABC6A9255/Router.cfm' />
			...
			<cffunction name='getAPIScript'>
				...
				<cfset jsonPacket['namespace'] = 'Ext.LB_47C95D7EBBAFB822F311290ABC6A9255' />
