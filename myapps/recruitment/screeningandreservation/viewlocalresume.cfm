...
<cfloop query="qryGMFPEOPLE">
    ...
    <cfset TINNUMBER         = '#TIN#'>
    <cfset LANDLINENUMBER    = '#HOTLINEPHONE#'>
    <cfset COMPANYCODE       = '#COMPANYCODE#'>
    <cfset CELLPHONENUMBER   = '#HOTLINECELLPHONE#'>
    <cfset EMAILADDRESS      = '#HOTLINEEMAIL#'>
...
<cfquery name="getpositiondesc" datasource="#session.company_dsn#" maxrows="1">
    ...
    SELECT DESCRIPTION
      FROM CLKPOSITION
     WHERE POSITIONCODE = '#qryCMFAP.POSITIONCODE#'
    ;
...
<cfloop query="qryCMFAP">

		<!---<cfset REFERENCECODE     = '#REFERENCECODE#'>--->
        <cfset SUFFIX                = '#SUFFIX#'>
        <cfset LASTNAME              = '#LASTNAME#'>
        <cfset FIRSTNAME             = '#FIRSTNAME#'>
        <cfset MIDDLENAME            = '#MIDDLENAME#'>
...
<cfquery name="qryCIN21PERSONALINFO" datasource="#session.company_dsn#" maxrows="1">
		   SELECT   GUID,
                    PERSONNELIDNO,
                    CONTACTADDRESS,
                    PROVINCIALADDRESS,
...
<cfquery name="religiontodesc" datasource="#session.global_dsn#" maxrows="1">
    ...
    SELECT DESCRIPTION
    FROM GLKRELIGION
    WHERE RELIGIONCODE = '#qryCIN21PERSONALINFO.RELIGIONCODE#'
...
<cfloop query="qryCIN21PERSONALINFO">
...
<cfquery name="qryCIN21POSITNAPLD1" datasource="#session.company_dsn#" maxrows="1">
		   SELECT   GUID,
                    PERSONNELIDNO,
                    POSITIONCODE,
                    DEPARTMENTCODE,
			...
			WHERE   GUID = '#theguid#' AND PRIORITY = 1;
</cfquery>
...
<cfloop query="qryCIN21POSITNAPLD1">

	<cfquery name="getpositiondes1" datasource="#DEPARTMENTCODE#_CBOSE" maxrows="1">
        SELECT DESCRIPTION
          FROM CLKPOSITION
    ...
    <cfquery name="getcompanydes1" datasource="#session.global_dsn#" maxrows="1">
        SELECT DESCRIPTION, COMPANYCODE  FROM GLKCOMPANY
         WHERE  COMPANYCODE = '#DEPARTMENTCODE#';
    </cfquery>
...
<cfquery name="qryCIN21POSITNAPLD2" datasource="#session.company_dsn#" maxrows="1">
		   SELECT   GUID,
                    PERSONNELIDNO,
                    POSITIONCODE,
                    DEPARTMENTCODE,
                    PRIORITY
			 FROM   CIN21POSITNAPLD
			WHERE   GUID = '#theguid#' AND PRIORITY = 2;
</cfquery>

<cfloop query="qryCIN21POSITNAPLD2">
	<cfquery name="getpositiondes2" datasource="#DEPARTMENTCODE#_CBOSE" maxrows="1">
        SELECT DESCRIPTION
          FROM CLKPOSITION
         WHERE POSITIONCODE = '#POSITIONCODE#';
    </cfquery>
...
<cfquery name="qryCIN21POSITNAPLD3" datasource="#session.company_dsn#" maxrows="1">
		   SELECT   GUID,
                    PERSONNELIDNO,
                    POSITIONCODE,
                    DEPARTMENTCODE,
                    PRIORITY
			 FROM   CIN21POSITNAPLD
			WHERE   GUID = '#theguid#' AND PRIORITY = 3;
</cfquery>

<cfloop query="qryCIN21POSITNAPLD3">
	<cfquery name="getpositiondes3" datasource="#DEPARTMENTCODE#_CBOSE" maxrows="1">
        SELECT DESCRIPTION
          FROM CLKPOSITION
         WHERE POSITIONCODE = '#POSITIONCODE#';
    </cfquery>
...
<cfquery name="qryCIN21FAMILYBKGRNDF" datasource="#session.company_dsn#" maxrows="1">
		   SELECT   GUID,
                    PERSONNELIDNO,
                    NAME,
                    AGE,
			...
			WHERE   GUID = '#theguid#' AND RELATIONSHIP LIKE '%FATHER%';
</cfquery>

<cfloop query="qryCIN21FAMILYBKGRNDF">
...
<cfquery name="qryCIN21FAMILYBKGRNDM" datasource="#session.company_dsn#" maxrows="1">
		   SELECT   GUID,
                    PERSONNELIDNO,
                    NAME,
                    AGE,
					...
					LIVINGORDEAD
			 FROM   CIN21FAMILYBKGRND
			WHERE   GUID = '#theguid#' AND RELATIONSHIP LIKE '%MOTHER%';
</cfquery>

<cfloop query="qryCIN21FAMILYBKGRNDM">
...
<cfquery name="qryCIN21FAMILYBKGRNDS" datasource="#session.company_dsn#" maxrows="1">
		   SELECT   GUID,
                    PERSONNELIDNO,
                    NAME,
                    AGE,
					...
					LIVINGORDEAD
			 FROM   CIN21FAMILYBKGRND
			WHERE   GUID = '#theguid#' AND RELATIONSHIP LIKE '%SPOUSE%';
</cfquery>

<cfloop query="qryCIN21FAMILYBKGRNDS">
...
<cfquery name="qryCIN21FAMILYBKGRNDCHILDREN" datasource="#session.company_dsn#">
		   SELECT   GUID,
                    PERSONNELIDNO,
                    NAME,
                    AGE,
					...
					LIVINGORDEAD
			 FROM   CIN21FAMILYBKGRND
			WHERE   GUID = '#theguid#' AND RELATIONSHIP LIKE '%SON%';
</cfquery>

<cfquery name="qryCIN21FAMILYBKGRNDSIBLING" datasource="#session.global_dsn#">
		   SELECT   GUID,
                    PERSONNELIDNO,
                    NAME,
                    AGE,
			...
			WHERE GUID = '#theguid#' AND RELATIONSHIP LIKE  '%BRO%';
</cfquery>


<cfquery name="qryCIN21EDUCATIONP" datasource="#session.company_dsn#" maxrows="1">
		   SELECT   GUID,
                    PERSONNELIDNO,
                    EDUCLEVEL,
					LOCATION,
                    ...
                    HONORSRECEIVED
			 FROM   CIN21EDUCATION
			WHERE   GUID = '#theguid#' AND EDUCLEVEL LIKE '%POSTGRAD%';
</cfquery>

<cfquery name="getschooldesc" datasource="#session.global_dsn#" maxrows="1">
    SELECT SCHOOLNAME
      FROM GLKSCHOOL
     WHERE SCHOOLCODE= '#qryCIN21EDUCATIONP.SCHOOLCODE#';
</cfquery>
...
<cfquery name="getcoursedesc" datasource="#session.global_dsn#" maxrows="1">
    SELECT DESCRIPTION
      FROM GLKCOURSE
     WHERE COURSECODE = '#qryCIN21EDUCATIONP.COURSECODE#';
</cfquery>
<cfset POSTGRADCOURSE = '#getcoursedesc.DESCRIPTION#'>


<cfloop query="qryCIN21EDUCATIONP">
...
<cfquery name="qryCIN21EDUCATIONC" datasource="#session.company_dsn#">
		   SELECT   GUID,
                    PERSONNELIDNO,
                    EDUCLEVEL,
					LOCATION,
                    ...
                    HONORSRECEIVED
			 FROM   CIN21EDUCATION
			WHERE   GUID = '#theguid#' AND EDUCLEVEL LIKE '%COLLEGE%';
</cfquery>


<cfquery name="qryCIN21EDUCATIONV" datasource="#session.company_dsn#">
		   SELECT   GUID,
                    PERSONNELIDNO,
                    EDUCLEVEL,
					LOCATION,
                    ...
                    HONORSRECEIVED
			 FROM   CIN21EDUCATION
			WHERE   GUID = '#theguid#' AND EDUCLEVEL LIKE '%VOCATIONAL%';
</cfquery>
...
<cfquery name="getschooldesc" datasource="#session.global_dsn#" maxrows="1">
    SELECT SCHOOLNAME
      FROM GLKSCHOOL
     WHERE SCHOOLCODE= '#qryCIN21EDUCATIONV.SCHOOLCODE#';
</cfquery>
...
<cfquery name="getcoursedesc" datasource="#session.global_dsn#" maxrows="1">
    SELECT DESCRIPTION
      FROM GLKCOURSE
     WHERE COURSECODE = '#qryCIN21EDUCATIONV.COURSECODE#';
</cfquery>
<cfset VOCATIONALCOURSE = '#getcoursedesc.DESCRIPTION#'>


<cfloop query="qryCIN21EDUCATIONV">
...
<cfquery name="qryCIN21EDUCATIONS" datasource="#session.company_dsn#">
		   SELECT   GUID,
                    PERSONNELIDNO,
                    EDUCLEVEL,
					LOCATION,
                    ...
                    HONORSRECEIVED
			 FROM   CIN21EDUCATION
			WHERE   GUID = '#theguid#' AND EDUCLEVEL LIKE '%SECONDARY%';
</cfquery>
...
<cfquery name="getschooldesc" datasource="#session.global_dsn#" maxrows="1">
    SELECT SCHOOLNAME
      FROM GLKSCHOOL
     WHERE SCHOOLCODE= '#qryCIN21EDUCATIONS.SCHOOLCODE#';
</cfquery>
...
<cfquery name="getcoursedesc" datasource="#session.global_dsn#" maxrows="1">
    SELECT DESCRIPTION
      FROM GLKCOURSE
     WHERE COURSECODE = '#qryCIN21EDUCATIONS.COURSECODE#';
</cfquery>
<cfset SECONDARYCOURSE = '#getcoursedesc.DESCRIPTION#'>


<cfloop query="qryCIN21EDUCATIONS">
...
<cfquery name="qryCIN21EMPEXTRA" datasource="#session.company_dsn#">
		   SELECT   GUID,
                    PERSONNELIDNO,
                    ORGANIZATION,
                    PERIODCOVERED,
...
<cfquery name="qryCIN21EXAMPASS" datasource="#session.company_dsn#">
		   SELECT   GUID,
                    PERSONNELIDNO,
                    DATETAKENPASSED,
                    PASSED,
...
<cfquery name="qryCIN21MEDHISTORY" datasource="#session.company_dsn#" maxrows="1">
		   SELECT   GUID,
                    PERSONNELIDNO,
                    BLOODTYPE
...
<cfloop query="qryCIN21MEDHISTORY">
...
<cfquery name="qryCIN21TRAINING" datasource="#session.company_dsn#">
		   SELECT   GUID,
                    PERSONNELIDNO,
                    INCLUSIVEDATE,
                    TOPIC,
...
<cfquery name="qryCIN21WORKHISTORY" datasource="#session.company_dsn#">
		   SELECT  GUID,
                   PERSONNELIDNO,
                   ENTITYCODE,
                   MAINDUTIES,
...
<cfquery name="qryCIN21RELATIVE" datasource="#session.company_dsn#">
		   SELECT  GUID,
                   PERSONNELIDNO,
                   NAME,
                   COMPANY,
...
<cfquery name="qryCIN21MISCINFO1" datasource="#session.company_dsn#">
		   SELECT  GUID,
                   PERSONNELIDNO,
                   SPECIALTALENTS,
                   CLASSIFICATION,
...
<cfquery name="qryCIN21CHAREFERENCE" datasource="#session.company_dsn#">
		   SELECT  GUID,
                   PERSONNELIDNO,
                   NAME,
                   OCCUPATION,
...
<cfloop query="qryCIN21CHAREFERENCE">
...
<cfquery name="qryCIN21EMPVIOL2" datasource="#session.company_dsn#">
		   SELECT  GUID,
                   PERSONNELIDNO,
                   CASENUMBER,
                   CASENAME,
                   CASESTATUS
			 FROM  CIN21EMPVIOL
			WHERE  GUID = '#theguid#' AND CASENUMBER = 'illness';
</cfquery>

<cfloop query="qryCIN21EMPVIOL2">
...
<cfquery name="qryCIN21EMPVIOL3" datasource="#session.company_dsn#">
		   SELECT  GUID,
                   PERSONNELIDNO,
                   CASENUMBER,
                   CASENAME,
                   CASESTATUS
			 FROM  CIN21EMPVIOL
			WHERE  GUID = '#theguid#' AND CASENUMBER = 'sensitive';
</cfquery>

<cfloop query="qryCIN21EMPVIOL3">
...
<cfquery name="qryCIN21EMPVIOL4" datasource="#session.company_dsn#">
		   SELECT  GUID,
                   PERSONNELIDNO,
                   CASENUMBER,
                   CASENAME,
                   CASESTATUS
			 FROM  CIN21EMPVIOL
			WHERE  GUID = '#theguid#' AND CASENUMBER = 'dangerous';
</cfquery>

<cfloop query="qryCIN21EMPVIOL4">
...
<cfquery name="qryCIN21EMPVIOL5" datasource="#session.company_dsn#">
		   SELECT  GUID,
                   PERSONNELIDNO,
                   CASENUMBER,
                   CASENAME,
                   CASESTATUS
			 FROM  CIN21EMPVIOL
			WHERE  GUID = '#theguid#' AND CASENUMBER = 'business';
</cfquery>

<cfloop query="qryCIN21EMPVIOL5">
...
<cfquery name="qryCIN21EMPVIOLN6" datasource="#session.company_dsn#">
		   SELECT  GUID,
                   PERSONNELIDNO,
                   CASENUMBER,
                   CASENAME,
                   CASESTATUS
			 FROM  CIN21EMPVIOL
			WHERE  GUID = '#theguid#' AND CASENUMBER = 'suspended';
</cfquery>

<cfloop query="qryCIN21EMPVIOLN6">
...
<cfquery name="qryCIN21EMPVIOL7" datasource="#session.company_dsn#">
		   SELECT  GUID,
                   PERSONNELIDNO,
                   CASENUMBER,
                   CASENAME,
                   CASESTATUS
			 FROM  CIN21EMPVIOL
			WHERE  GUID = '#theguid#' AND CASENUMBER = 'convicted';
</cfquery>

<cfloop query="qryCIN21EMPVIOL7">
	...
	<table style="font-size: 12px; font-family: Arial, Helvetica, sans-serif; border: 1px solid #666;">
		...
		<cfset namecnt = 1 />
		<cfloop query="qryCIN21FAMILYBKGRNDCHILDREN">
		...
		<cfset namecnt = 1 />
		<cfloop query="qryCIN21FAMILYBKGRNDSIBLING">
      ...
      <cfset secondarycheck = "#SECONDARYISGRAD#">
		...
		<cfset collegecnt = 1 />
		<cfloop query="qryCIN21EDUCATIONC">

			<cfquery name="getschooldesc" datasource="#session.global_dsn#" maxrows="1">
			    SELECT SCHOOLNAME
			      FROM GLKSCHOOL
			     WHERE SCHOOLCODE= '#qryCIN21EDUCATIONC.SCHOOLCODE#';
			</cfquery>

			<cfquery name="getcoursedesc" datasource="#session.global_dsn#" maxrows="1">
			    SELECT DESCRIPTION
			      FROM GLKCOURSE
			     WHERE COURSECODE = '#qryCIN21EDUCATIONC.COURSECODE#';
			</cfquery>
		...
		<cfloop query="qryCIN21WORKHISTORY">
		...
		<cfset counter = 1 >
		<cfloop query="qryCIN21MISCINFO1">
