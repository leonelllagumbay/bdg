...
Ext.application({
	...
	name: 'Form',
	controllers: [
		'recruitment.screeningandreservation.controller'
	],
	...
	console.log('sec');
		Ext.create('Ext.container.Viewport', {
			...
			items: [{
				...
				items: [{
						xtype: 'globalpool',
						title: '&nbsp&nbsp&nbsp&nbspGlobal Pool&nbsp&nbsp&nbsp&nbsp'
				},{
						xtype: 'mrfdataview',
						title: '&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspMRF&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp'
				},{
						xtype: 'localpool',    
						title: '&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspLocal&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp'
				}]
			}],
