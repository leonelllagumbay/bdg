<cfcomponent persistent="true" table="EGRGQUERY">
	...
	<cfproperty name="COMPANYCODE" type="string">
	...
	<cfproperty name="EGRTQUERY" cfc="EGRTQUERY" type="array" fieldtype="one-to-many" fkcolumn="EQRYCODE" cascade="all-delete-orphan" >
	<cfproperty name="EGRTQUERYGROUP" cfc="EGRTQUERYGROUP" type="array" fieldtype="one-to-many" fkcolumn="EQRYCODE" cascade="all-delete-orphan" >
</cfcomponent>