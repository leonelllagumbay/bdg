		...
		<cfquery name="getRoleFromGroup" datasource="#session.global_dsn#"> 
			SELECT A.USERGRPMEMBERSIDX, B.USERID, B.GUID AS GUID  
			 ...
			 WHERE USERGRPID_FK = '#form.G__EGRTMENU__APPLICANTNUMBER#'
		</cfquery>
				...
				<cfif getPIDfromMainTable.recordcount GT 0 >
					<cftry>
						<cfquery name="grant" datasource="#session.global_dsn#" >
					    	INSERT INTO EGRTMENU (MENUID, APPLICANTNUMBER, PERSONNELIDNO, EFORMID, PROCESSID, APPROVED, DATELASTUPDATE, RECDATECREATED)
					            VALUES (<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.G__EGRTMENU__MENUID#" >,
