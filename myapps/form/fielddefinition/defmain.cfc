...
<cfset processData.setISENCRYPTED("#form.ISENCRYPTED#") >
...
<cfset processData.setAUDITTDSOURCE("#form.AUDITTDSOURCE#") >
<cfset processData.setAUDITTNAME("#form.AUDITTNAME#") >
<cfset processData.setLOGDBSOURCE("#form.LOGDBSOURCE#") >
<cfset processData.setLOGTABLENAME("#form.LOGTABLENAME#") >
<cfset processData.setLOGFILENAME("#form.LOGFILENAME#") >
