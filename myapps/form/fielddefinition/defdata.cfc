...
<cfset countAll = ORMExecuteQuery("FROM EGRGEFORMS #WHERE#" )> 
	...
	<cfloop array="#processData#" index="calIndex" >
		...
		<cfset tmpresult['ONBEFOREDELETE'] 	= calIndex.getONBEFOREDELETE()  >
		<cfset tmpresult['ONAFTERDELETE'] 	= calIndex.getONAFTERDELETE()  >
		<cfset tmpresult['ONBEFOREROUTE'] 	= calIndex.getONBEFOREROUTE()  >
		<cfset tmpresult['ONAFTERROUTE'] 	= calIndex.getONAFTERROUTE()  >
		<cfset tmpresult['COMPANYCODE'] 	= calIndex.getCOMPANYCODE()  >
		<cfset tmpresult['AUDITTDSOURCE'] 	= calIndex.getAUDITTDSOURCE()  >
		<cfset tmpresult['AUDITTNAME'] 		= calIndex.getAUDITTNAME()  >
		<cfset tmpresult['LOGDBSOURCE'] 	= calIndex.getLOGDBSOURCE()  >
		<cfset tmpresult['LOGTABLENAME'] 	= calIndex.getLOGTABLENAME()  >
		<cfset tmpresult['LOGFILENAME'] 	= calIndex.getLOGFILENAME()  >
...
<cfset processData.setDATELASTUPDATE("#dateformat(now(), 'YYYY-MM-DD')# #timeformat(now(), 'HH:MM:SS')#") >
