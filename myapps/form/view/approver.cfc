...
<cfset countAll = ORMExecuteQuery("FROM EGINROUTERAPPROVERS #WHERE#" )>
	...
	<cfloop array="#processData#" index="calIndex" >
		...
		<cfset tmpresult['APPROVEDVALUE']      = calIndex.getAPPROVEDVALUE()  >
		<cfset tmpresult['DISAPPROVEDVALUE']      = calIndex.getDISAPPROVEDVALUE()  >
...
<cfset processData.setAPPROVEDVALUE("#datatoupdate.APPROVEDVALUE#") >
<cfset processData.setDISAPPROVEDVALUE("#datatoupdate.DISAPPROVEDVALUE#") >
...
<cfset processData.setAPPROVEDVALUE("#form.APPROVEDVALUE#") >
<cfset processData.setDISAPPROVEDVALUE("#form.DISAPPROVEDVALUE#") >
