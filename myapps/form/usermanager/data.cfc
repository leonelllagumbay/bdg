...
<cftry>
	<cfif trim(theRole) eq "" > <!---the individual user is used--->
		...
		<cfset rtForm = EntityNew("EGRTEFORMS") />
		<cfset rtCount = EntityNew("EGINEFORMCOUNT") />
		<cfset rtForm.setEFORMID(eformid) />
		<cfset rtForm.setPERSONNELIDNO(thepid) />
		<cfset rtCount.setEFORMID(eformid) />
		<cfset rtCount.setPERSONNELIDNO(thepid) />
		<cfset rtCount.setNEW(0) />
		<cfset rtCount.setPENDING(0) />
		<cfset rtCount.setRETURNED(0) />
		<cfset rtCount.setAPPROVED(0) />
		<cfset rtCount.setDISAPPROVED(0) />
		<cfset rtForm.setEGINEFORMCOUNT(rtCount) />
		<cfset EntitySave(rtForm) />
		<cfset EntitySave(rtCount) />
	    <cfset OrmFlush() />
			...
			<cfloop query="getRoleFromGroup" >
				...
				<cfif getPIDfromMainTable.recordcount GT 0 >
					<cftry>
						...
						<cfset rtCount = EntityNew("EGINEFORMCOUNT") />
						<cfset rtForm.setEFORMID(eformid) />
						<cfset rtForm.setPERSONNELIDNO(getPIDfromMainTable.PID) />
						<cfset rtCount.setEFORMID(eformid) />
						<cfset rtCount.setPERSONNELIDNO(getPIDfromMainTable.PID) />
						<cfset rtForm.setEGINEFORMCOUNT(rtCount) />
						<cfset EntitySave(rtForm) />
						<cfset EntitySave(rtCount) />
					    <cfset OrmFlush() />
