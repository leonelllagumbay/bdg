...
<cfinvoke component="IBOSE.administrator.Email" method="setUpMailAttr" returnvariable="acoll">
	...
	<cfmail attributeCollection="#acoll#"
			from="#session.websiteemailadd#"
			to="#emaillist#,#extraRecipients#"
			subject="#theSubject#"
			type="html"
			>
			<font color="Maroon" style="font: 21px Arial">#session.companyname#</font><br>
			<img title="#session.companyname#" height="35" width="150" src="#session.domain#/resource/image/companylogo/#session.site_bannerlogo#">
			<table id="eformnotif" border="1" cellpadding="3" cellspacing="1" style="font: 13px Arial; border-collapse: collapse;" width = "550">
