...
<cfset dtmptbl = ucase("fbc_gbose.gmfpeople") />
<cfset dtmptbl = rereplace(dtmptbl, "(?:.*GBOSE\.DBO|.*GBOSE|IBOSE_GLOBAL\.DBO|IBOSE_GLOBAL)\.", "") />
<cfoutput>#dtmptbl#</cfoutput><br />

<cfset dtmptbl = ucase("ibose_global.egrgusermaster") />
<cfset dtmptbl = rereplace(dtmptbl, "(?:.*GBOSE\.DBO|.*GBOSE|IBOSE_GLOBAL\.DBO|IBOSE_GLOBAL)\.", "") />
<cfoutput>#dtmptbl#</cfoutput><br />

<cfset dtmptbl = ucase("fbc_gbose.dbo.gmfpeople") />
<cfset dtmptbl = rereplace(dtmptbl, "(?:.*GBOSE\.DBO|.*GBOSE|IBOSE_GLOBAL\.DBO|IBOSE_GLOBAL)\.", "") />
<cfoutput>#dtmptbl#</cfoutput><br />

<cfset dtmptbl = ucase("ibose_global.dbo.egrgusermaster") />
<cfset dtmptbl = rereplace(dtmptbl, "(?:.*GBOSE\.DBO|.*GBOSE|IBOSE_GLOBAL\.DBO|IBOSE_GLOBAL)\.", "") />
<cfoutput>#dtmptbl#</cfoutput>