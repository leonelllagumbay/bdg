...
Ext.onReady(function(){
    ...
    function renderTopic(value, p, record) {
        return Ext.String.format(
            '<a href="mrfviewer.cfm?reqno=' + record.data.REQUISITIONNO + '&yesrevert=YESREVERT' + '&dbms=' + record.data.DBMS + '&cd=' + record.data.COMPANYDSN + '&companycode=' + record.data.COMPANYCODE + '" target="_blank">{0}</a>',
            value,
