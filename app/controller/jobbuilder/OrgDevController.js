Ext.define('Form.controller.jobbuilder.OrgDevController', {
   	extend: 'Ext.app.Controller',
   	views: ['jobbuilder.OrgDevView'],
   	models: ['jobbuilder.OrgDevModel'],
   	stores: ['jobbuilder.OrgDevStore'],
   		init: function() {
   			this.control({
   				'panel': {
	   		...
	   		if (b.action) {
				...
				var fwin = Ext.create('Ext.window.Window', {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
				    			var dgrid = Ext.widget('orgdevview');
				...
				if (dgdata) df.setValues(dgdata.data);
	       		...
	       		Ext.Msg.show({
					...
					Ext.jobbuilder.OrgDev.exportGridToExcel(qrycode, qrytitle, function(res) {
						dgrid.getEl().unmask();
						if (res.result !== true) {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
					    		...
					    		Ext.jobbuilder.OrgDev.emailSelGridQuery(fromv,tov,subjectv,bodyv,function(res) {
					    			dwin.getEl().unmask();
					    			if (res.success !== true) {
