Ext.define('Form.controller.queryoutput.FBC.NS_1B6EC9A20EAEF9391311AAEDBB9B82B5.Controller', {
   	extend: 'Ext.app.Controller',
   	views: ['queryoutput.FBC.NS_1B6EC9A20EAEF9391311AAEDBB9B82B5.View'],
   	models: ['queryoutput.FBC.NS_1B6EC9A20EAEF9391311AAEDBB9B82B5.Model'],
   	stores: ['queryoutput.FBC.NS_1B6EC9A20EAEF9391311AAEDBB9B82B5.Store'],
   		init: function() {
   			this.control({
   				'panel': {
   					render: this.initPanel
   				},
   				'NS_1B6EC9A20EAEF9391311AAEDBB9B82B5 button': {
   					click: this.topBarButtonClicked
   				},
   				'NS_1B6EC9A20EAEF9391311AAEDBB9B82B5': {
			...
			topBarButtonClicked: function(b) {
	   		if (b.action) {
				...
				var dw = Ext.create('Ext.window.Window', {
				    ...
				    items: [{
				    	xtype: 'form',
				    	id: 'viewform205AC883-03D0-4F95-3DE34D834CB7F64F',
				    	autoScroll: true,
				    	items: [{
							width: '95%',name: 'cmfpa-PERSONNELIDNO',
							fieldLabel: 'Personnel ID',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cmfpa-FIRSTNAME',
							fieldLabel: 'First Name',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cmfpa-MIDDLENAME',
							fieldLabel: 'Middle Name',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cmfpa-LASTNAME',
							fieldLabel: 'Last Name',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cmfpa-DATEHIRED',
							fieldLabel: 'Date Hired',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cmfpa-SUPERIORCODE',
							fieldLabel: 'Immediate Superior',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cmfpa-GUID',
							fieldLabel: 'Guid',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
							...
							width: '95%',name: 'cmfpa-FIRSTNAME',
							fieldLabel: 'Superior First Name',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cmfpa-LASTNAME',
							fieldLabel: 'Superior Last Name',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						}]
				...
				var fwin = Ext.create('Ext.window.Window', {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
				    			var dgrid = Ext.widget('NS_1B6EC9A20EAEF9391311AAEDBB9B82B5');
				...
				if (dgdata) df.setValues(dgdata.data);
	       		...
	       		Ext.Msg.show({
					...
					var qrytitle = 'Personal Information';
					var qrycode = '1B6EC9A2-0EAE-F939-1311AAEDBB9B82B5';
					Ext.NS_1B6EC9A20EAEF9391311AAEDBB9B82B5.Data.exportGridToExcel(qrycode, qrytitle, function(res) {
						dgrid.getEl().unmask();
						if (res.result !== true) {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
					    		...
					    		Ext.NS_1B6EC9A20EAEF9391311AAEDBB9B82B5.Data.emailSelGridQuery(fromv,tov,subjectv,bodyv,function(res) {
					    			dwin.getEl().unmask();
					    			if (res.success !== true) {
   		...
   		gridRenderingComplete: function(dis, eopts) {
   			var qc = '1B6EC9A2-0EAE-F939-1311AAEDBB9B82B5';
   			Ext.NS_1B6EC9A20EAEF9391311AAEDBB9B82B5.Data.getUserToolbars(qc, function(res) {
   				if (res.success) {
   					dis.addDocked(res);
   				}
   			});
   		...
   		gridRecordedSelected: function(dis, rec, ind) {
   			var formCmp = Ext.getCmp('viewform205AC883-03D0-4F95-3DE34D834CB7F64F') || Ext.getCmp('autoeformididid');
   			if (formCmp) {
