Ext.define('Form.controller.queryoutput.FBC.NS_2ECCDD3A98CCBCB8A067E085619C45D4.Controller', {
   	extend: 'Ext.app.Controller',
   	views: ['queryoutput.FBC.NS_2ECCDD3A98CCBCB8A067E085619C45D4.View'],
   	models: ['queryoutput.FBC.NS_2ECCDD3A98CCBCB8A067E085619C45D4.Model'],
   	stores: ['queryoutput.FBC.NS_2ECCDD3A98CCBCB8A067E085619C45D4.Store'],
   		init: function() {
   			this.control({
   				'panel': {
   					render: this.initPanel
   				},
   				'NS_2ECCDD3A98CCBCB8A067E085619C45D4 button': {
   					click: this.topBarButtonClicked
   				},
   				'NS_2ECCDD3A98CCBCB8A067E085619C45D4': {
			...
			topBarButtonClicked: function(b) {
	   		if (b.action) {
				...
				var dw = Ext.create('Ext.window.Window', {
				    ...
				    items: [{
				    	xtype: 'form',
				    	id: 'viewform527FD370-CBD6-94A3-ADD8C0490CF6BB50',
				    	autoScroll: true,
				    	items: [{
							...
							width: '95%',name: 'cin21positnapld-PRIORITY',
							fieldLabel: 'Priority',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21positnapld-RECOMMENDATION',
							fieldLabel: 'Recommendation',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21positnapld-POSITIONCODE',
							fieldLabel: 'Position Code',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21positnapld-DEPARTMENTCODE',
							fieldLabel: 'Department Code',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21positnapld-LOCATIONCODE',
							fieldLabel: 'Location Code',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21positnapld-SECTIONCODE',
							fieldLabel: 'Section Code',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21positnapld-DIVISIONCODE',
				...
				var fwin = Ext.create('Ext.window.Window', {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
				    			var dgrid = Ext.widget('NS_2ECCDD3A98CCBCB8A067E085619C45D4');
				...
				if (dgdata) df.setValues(dgdata.data);
	       		...
	       		Ext.Msg.show({
					...
					var qrytitle = 'Positions Applied';
					var qrycode = '2ECCDD3A-98CC-BCB8-A067E085619C45D4';
					Ext.NS_2ECCDD3A98CCBCB8A067E085619C45D4.Data.exportGridToExcel(qrycode, qrytitle, function(res) {
						dgrid.getEl().unmask();
						if (res.result !== true) {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
					    		...
					    		Ext.NS_2ECCDD3A98CCBCB8A067E085619C45D4.Data.emailSelGridQuery(fromv,tov,subjectv,bodyv,function(res) {
					    			dwin.getEl().unmask();
					    			if (res.success !== true) {
   		...
   		gridRenderingComplete: function(dis, eopts) {
   			var qc = '2ECCDD3A-98CC-BCB8-A067E085619C45D4';
   			Ext.NS_2ECCDD3A98CCBCB8A067E085619C45D4.Data.getUserToolbars(qc, function(res) {
   				if (res.success) {
   					dis.addDocked(res);
   				}
   			});
   		...
   		gridRecordedSelected: function(dis, rec, ind) {
   			var formCmp = Ext.getCmp('viewform527FD370-CBD6-94A3-ADD8C0490CF6BB50') || Ext.getCmp('autoeformididid');
   			if (formCmp) {
