Ext.define('Form.controller.queryoutput.FBC.NS_2C00DDDEC1818E01004206E638E9EEDF.Controller', {
   	extend: 'Ext.app.Controller',
   	views: ['queryoutput.FBC.NS_2C00DDDEC1818E01004206E638E9EEDF.View'],
   	models: ['queryoutput.FBC.NS_2C00DDDEC1818E01004206E638E9EEDF.Model'],
   	stores: ['queryoutput.FBC.NS_2C00DDDEC1818E01004206E638E9EEDF.Store'],
   		init: function() {
   			this.control({
   				'panel': {
   					render: this.initPanel
   				},
   				'NS_2C00DDDEC1818E01004206E638E9EEDF button': {
   					click: this.topBarButtonClicked
   				},
   				'NS_2C00DDDEC1818E01004206E638E9EEDF': {
			...
			topBarButtonClicked: function(b) {
	   		if (b.action) {
				...
				var dw = Ext.create('Ext.window.Window', {
				    ...
				    items: [{
				    	xtype: 'form',
				    	id: 'viewform2C48854D-C7D9-F6AB-AD7F9B9C52189B26',
				    	autoScroll: true,
				    	items: [{
							width: '95%',name: 'cin21achievements-AWARDTITLE',
							fieldLabel: 'Award Title',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21achievements-NATURECATEGORY',
							fieldLabel: 'Nature or Category',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21achievements-DATEGIVEN',
							fieldLabel: 'Date Given',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21achievements-GIVENBY',
							fieldLabel: 'Given By',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
				...
				var fwin = Ext.create('Ext.window.Window', {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
				    			var dgrid = Ext.widget('NS_2C00DDDEC1818E01004206E638E9EEDF');
				...
				if (dgdata) df.setValues(dgdata.data);
	       		...
	       		Ext.Msg.show({
					...
					var qrytitle = 'Achievements';
					var qrycode = '2C00DDDE-C181-8E01-004206E638E9EEDF';
					Ext.NS_2C00DDDEC1818E01004206E638E9EEDF.Data.exportGridToExcel(qrycode, qrytitle, function(res) {
						dgrid.getEl().unmask();
						if (res.result !== true) {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
					    		...
					    		Ext.NS_2C00DDDEC1818E01004206E638E9EEDF.Data.emailSelGridQuery(fromv,tov,subjectv,bodyv,function(res) {
					    			dwin.getEl().unmask();
					    			if (res.success !== true) {
   		...
   		gridRenderingComplete: function(dis, eopts) {
   			var qc = '2C00DDDE-C181-8E01-004206E638E9EEDF';
   			Ext.NS_2C00DDDEC1818E01004206E638E9EEDF.Data.getUserToolbars(qc, function(res) {
   				if (res.success) {
   					dis.addDocked(res);
   				}
   			});
   		...
   		gridRecordedSelected: function(dis, rec, ind) {
   			var formCmp = Ext.getCmp('viewform2C48854D-C7D9-F6AB-AD7F9B9C52189B26') || Ext.getCmp('autoeformididid');
   			if (formCmp) {
