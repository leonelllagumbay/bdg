Ext.define('Form.controller.queryoutput.FBC.NS_80BB57F2FABDAC4A25D485EE2B5FBD39.Controller', {
   	extend: 'Ext.app.Controller',
   	views: ['queryoutput.FBC.NS_80BB57F2FABDAC4A25D485EE2B5FBD39.View'],
   	models: ['queryoutput.FBC.NS_80BB57F2FABDAC4A25D485EE2B5FBD39.Model'],
   	stores: ['queryoutput.FBC.NS_80BB57F2FABDAC4A25D485EE2B5FBD39.Store'],
   		init: function() {
   			this.control({
   				'panel': {
   					render: this.initPanel
   				},
   				'NS_80BB57F2FABDAC4A25D485EE2B5FBD39 button': {
   					click: this.topBarButtonClicked
   				},
   				'NS_80BB57F2FABDAC4A25D485EE2B5FBD39': {
			...
			topBarButtonClicked: function(b) {
	   		if (b.action) {
				...
				var dw = Ext.create('Ext.window.Window', {
				    ...
				    items: [{
				    	xtype: 'form',
				    	id: 'viewform80E02FB8-B628-D1C0-5FFA4D35F03F745E',
				    	autoScroll: true,
				    	items: [{
							width: '95%',name: 'clkdepartment-DEPARTMENTCODE',
							...
							fieldLabel: 'First Name of DH',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cmfpa-LASTNAME',
							fieldLabel: 'Last Name of DH',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'clkdepartment-DEPARTMENTHEAD',
							fieldLabel: 'Department Head PID',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						}]
				...
				var fwin = Ext.create('Ext.window.Window', {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
				    			var dgrid = Ext.widget('NS_80BB57F2FABDAC4A25D485EE2B5FBD39');
				...
				if (dgdata) df.setValues(dgdata.data);
	       		...
	       		Ext.Msg.show({
					...
					var qrytitle = 'Data Editor - CLKDEPARTMENT';
					var qrycode = '80BB57F2-FABD-AC4A-25D485EE2B5FBD39';
					Ext.NS_80BB57F2FABDAC4A25D485EE2B5FBD39.Data.exportGridToExcel(qrycode, qrytitle, function(res) {
						dgrid.getEl().unmask();
						if (res.result !== true) {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
					    		...
					    		Ext.NS_80BB57F2FABDAC4A25D485EE2B5FBD39.Data.emailSelGridQuery(fromv,tov,subjectv,bodyv,function(res) {
					    			dwin.getEl().unmask();
					    			if (res.success !== true) {
   		...
   		gridRenderingComplete: function(dis, eopts) {
   			var qc = '80BB57F2-FABD-AC4A-25D485EE2B5FBD39';
   			Ext.NS_80BB57F2FABDAC4A25D485EE2B5FBD39.Data.getUserToolbars(qc, function(res) {
   				if (res.success) {
   					dis.addDocked(res);
   				}
   			});
   		...
   		gridRecordedSelected: function(dis, rec, ind) {
   			var formCmp = Ext.getCmp('viewform80E02FB8-B628-D1C0-5FFA4D35F03F745E') || Ext.getCmp('autoeformididid');
   			if (formCmp) {
