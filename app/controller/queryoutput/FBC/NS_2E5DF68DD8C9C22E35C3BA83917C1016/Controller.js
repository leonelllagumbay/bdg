Ext.define('Form.controller.queryoutput.FBC.NS_2E5DF68DD8C9C22E35C3BA83917C1016.Controller', {
   	extend: 'Ext.app.Controller',
   	views: ['queryoutput.FBC.NS_2E5DF68DD8C9C22E35C3BA83917C1016.View'],
   	models: ['queryoutput.FBC.NS_2E5DF68DD8C9C22E35C3BA83917C1016.Model'],
   	stores: ['queryoutput.FBC.NS_2E5DF68DD8C9C22E35C3BA83917C1016.Store'],
   		init: function() {
   			this.control({
   				'panel': {
   					render: this.initPanel
   				},
   				'NS_2E5DF68DD8C9C22E35C3BA83917C1016 button': {
   					click: this.topBarButtonClicked
   				},
   				'NS_2E5DF68DD8C9C22E35C3BA83917C1016': {
			...
			topBarButtonClicked: function(b) {
	   		if (b.action) {
				...
				var dw = Ext.create('Ext.window.Window', {
				    ...
				    items: [{
				    	xtype: 'form',
				    	id: 'viewform2E87F857-CCA4-8F10-B47EFEAA553D6443',
				    	autoScroll: true,
				    	items: [{
							width: '95%',name: 'cin21empextra-ORGANIZATION',
							fieldLabel: 'Organization',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21empextra-HIGHESTPOSITION',
							fieldLabel: 'Highest Position',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21empextra-PERIODCOVERED',
							fieldLabel: 'Period Covered',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						}]
				...
				var fwin = Ext.create('Ext.window.Window', {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
				    			var dgrid = Ext.widget('NS_2E5DF68DD8C9C22E35C3BA83917C1016');
				...
				if (dgdata) df.setValues(dgdata.data);
	       		...
	       		Ext.Msg.show({
					...
					var qrytitle = 'Extra-curricular Activities';
					var qrycode = '2E5DF68D-D8C9-C22E-35C3BA83917C1016';
					Ext.NS_2E5DF68DD8C9C22E35C3BA83917C1016.Data.exportGridToExcel(qrycode, qrytitle, function(res) {
						dgrid.getEl().unmask();
						if (res.result !== true) {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
					    		...
					    		Ext.NS_2E5DF68DD8C9C22E35C3BA83917C1016.Data.emailSelGridQuery(fromv,tov,subjectv,bodyv,function(res) {
					    			dwin.getEl().unmask();
					    			if (res.success !== true) {
   		...
   		gridRenderingComplete: function(dis, eopts) {
   			var qc = '2E5DF68D-D8C9-C22E-35C3BA83917C1016';
   			Ext.NS_2E5DF68DD8C9C22E35C3BA83917C1016.Data.getUserToolbars(qc, function(res) {
   				if (res.success) {
   					dis.addDocked(res);
   				}
   			});
   		...
   		gridRecordedSelected: function(dis, rec, ind) {
   			var formCmp = Ext.getCmp('viewform2E87F857-CCA4-8F10-B47EFEAA553D6443') || Ext.getCmp('autoeformididid');
   			if (formCmp) {
