Ext.define('Form.controller.queryoutput.FBC.NS_2EB36DCDD5008766558EB666CD0ABA99.Controller', {
   	extend: 'Ext.app.Controller',
   	views: ['queryoutput.FBC.NS_2EB36DCDD5008766558EB666CD0ABA99.View'],
   	models: ['queryoutput.FBC.NS_2EB36DCDD5008766558EB666CD0ABA99.Model'],
   	stores: ['queryoutput.FBC.NS_2EB36DCDD5008766558EB666CD0ABA99.Store'],
   		init: function() {
   			this.control({
   				'panel': {
   					render: this.initPanel
   				},
   				'NS_2EB36DCDD5008766558EB666CD0ABA99 button': {
   					click: this.topBarButtonClicked
   				},
   				'NS_2EB36DCDD5008766558EB666CD0ABA99': {
			...
			topBarButtonClicked: function(b) {
	   		if (b.action) {
				...
				var dw = Ext.create('Ext.window.Window', {
				    ...
				    items: [{
				    	xtype: 'form',
				    	id: 'viewform51155FAA-BA14-580D-B3011A9F754C5903',
				    	autoScroll: true,
				    	items: [{
							width: '95%',name: 'cin21exampass-TYPEOFEXAM',
							fieldLabel: 'Type of Exam',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21exampass-DATETAKENPASSED',
							fieldLabel: 'Date Taken',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21exampass-RATING',
							fieldLabel: 'Rating',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21exampass-LICENSENUMBER',
							fieldLabel: 'License Number',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21exampass-PASSED',
							fieldLabel: 'Passed',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21exampass-REMARKS',
							fieldLabel: 'Remarks',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21exampass-EXPIRATIONDATE',
				...
				var fwin = Ext.create('Ext.window.Window', {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
				    			var dgrid = Ext.widget('NS_2EB36DCDD5008766558EB666CD0ABA99');
				...
				if (dgdata) df.setValues(dgdata.data);
	       		...
	       		Ext.Msg.show({
					...
					var qrytitle = 'Exam Passed';
					var qrycode = '2EB36DCD-D500-8766-558EB666CD0ABA99';
					Ext.NS_2EB36DCDD5008766558EB666CD0ABA99.Data.exportGridToExcel(qrycode, qrytitle, function(res) {
						dgrid.getEl().unmask();
						if (res.result !== true) {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
					    		...
					    		Ext.NS_2EB36DCDD5008766558EB666CD0ABA99.Data.emailSelGridQuery(fromv,tov,subjectv,bodyv,function(res) {
					    			dwin.getEl().unmask();
					    			if (res.success !== true) {
   		...
   		gridRenderingComplete: function(dis, eopts) {
   			var qc = '2EB36DCD-D500-8766-558EB666CD0ABA99';
   			Ext.NS_2EB36DCDD5008766558EB666CD0ABA99.Data.getUserToolbars(qc, function(res) {
   				if (res.success) {
   					dis.addDocked(res);
   				}
   			});
   		...
   		gridRecordedSelected: function(dis, rec, ind) {
   			var formCmp = Ext.getCmp('viewform51155FAA-BA14-580D-B3011A9F754C5903') || Ext.getCmp('autoeformididid');
   			if (formCmp) {
