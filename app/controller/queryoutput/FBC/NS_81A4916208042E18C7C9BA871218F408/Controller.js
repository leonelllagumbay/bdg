Ext.define('Form.controller.queryoutput.FBC.NS_81A4916208042E18C7C9BA871218F408.Controller', {
   	extend: 'Ext.app.Controller',
   	views: ['queryoutput.FBC.NS_81A4916208042E18C7C9BA871218F408.View'],
   	models: ['queryoutput.FBC.NS_81A4916208042E18C7C9BA871218F408.Model'],
   	stores: ['queryoutput.FBC.NS_81A4916208042E18C7C9BA871218F408.Store'],
   		init: function() {
   			this.control({
   				'panel': {
   					render: this.initPanel
   				},
   				'NS_81A4916208042E18C7C9BA871218F408 button': {
   					click: this.topBarButtonClicked
   				},
   				'NS_81A4916208042E18C7C9BA871218F408': {
			...
			topBarButtonClicked: function(b) {
	   		if (b.action) {
				...
				var dw = Ext.create('Ext.window.Window', {
				    ...
				    items: [{
				    	xtype: 'form',
				    	id: 'viewform81AA76BE-0108-BA2A-86B95643592216F3',
				    	autoScroll: true,
				    	items: [{
							width: '95%',name: 'glkeduclevel-EDUCLEVEL',
							fieldLabel: 'Educ Level Code',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
				...
				var fwin = Ext.create('Ext.window.Window', {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
				    			var dgrid = Ext.widget('NS_81A4916208042E18C7C9BA871218F408');
				...
				if (dgdata) df.setValues(dgdata.data);
	       		...
	       		Ext.Msg.show({
					...
					var qrytitle = 'Data Editor - GLKEDUCLEVEL';
					var qrycode = '81A49162-0804-2E18-C7C9BA871218F408';
					Ext.NS_81A4916208042E18C7C9BA871218F408.Data.exportGridToExcel(qrycode, qrytitle, function(res) {
						dgrid.getEl().unmask();
						if (res.result !== true) {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
					    		...
					    		Ext.NS_81A4916208042E18C7C9BA871218F408.Data.emailSelGridQuery(fromv,tov,subjectv,bodyv,function(res) {
					    			dwin.getEl().unmask();
					    			if (res.success !== true) {
   		...
   		gridRenderingComplete: function(dis, eopts) {
   			var qc = '81A49162-0804-2E18-C7C9BA871218F408';
   			Ext.NS_81A4916208042E18C7C9BA871218F408.Data.getUserToolbars(qc, function(res) {
   				if (res.success) {
   					dis.addDocked(res);
   				}
   			});
   		...
   		gridRecordedSelected: function(dis, rec, ind) {
   			var formCmp = Ext.getCmp('viewform81AA76BE-0108-BA2A-86B95643592216F3') || Ext.getCmp('autoeformididid');
   			if (formCmp) {
