Ext.define('Form.controller.queryoutput.FBC.NS_2EDB6F3AD5A2279C9E6B8690031891A8.Controller', {
   	extend: 'Ext.app.Controller',
   	views: ['queryoutput.FBC.NS_2EDB6F3AD5A2279C9E6B8690031891A8.View'],
   	models: ['queryoutput.FBC.NS_2EDB6F3AD5A2279C9E6B8690031891A8.Model'],
   	stores: ['queryoutput.FBC.NS_2EDB6F3AD5A2279C9E6B8690031891A8.Store'],
   		init: function() {
   			this.control({
   				'panel': {
   					render: this.initPanel
   				},
   				'NS_2EDB6F3AD5A2279C9E6B8690031891A8 button': {
   					click: this.topBarButtonClicked
   				},
   				'NS_2EDB6F3AD5A2279C9E6B8690031891A8': {
			...
			topBarButtonClicked: function(b) {
	   		if (b.action) {
				...
				var dw = Ext.create('Ext.window.Window', {
				    ...
				    items: [{
				    	xtype: 'form',
				    	id: 'viewform52BF304B-F632-0CBC-301B3EE59BAA3F32',
				    	autoScroll: true,
				    	items: [{
							width: '95%',name: 'cin21training-TOPIC',
							fieldLabel: 'Topic',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21training-VENUE',
							fieldLabel: 'Venue',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21training-INCLUSIVEDATE',
							fieldLabel: 'Inclusive Date',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21training-REMARKS',
							fieldLabel: 'Remarks',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
				...
				var fwin = Ext.create('Ext.window.Window', {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
				    			var dgrid = Ext.widget('NS_2EDB6F3AD5A2279C9E6B8690031891A8');
				...
				if (dgdata) df.setValues(dgdata.data);
	       		...
	       		Ext.Msg.show({
					...
					var qrytitle = 'Trainings';
					var qrycode = '2EDB6F3A-D5A2-279C-9E6B8690031891A8';
					Ext.NS_2EDB6F3AD5A2279C9E6B8690031891A8.Data.exportGridToExcel(qrycode, qrytitle, function(res) {
						dgrid.getEl().unmask();
						if (res.result !== true) {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
					    		...
					    		Ext.NS_2EDB6F3AD5A2279C9E6B8690031891A8.Data.emailSelGridQuery(fromv,tov,subjectv,bodyv,function(res) {
					    			dwin.getEl().unmask();
					    			if (res.success !== true) {
   		...
   		gridRenderingComplete: function(dis, eopts) {
   			var qc = '2EDB6F3A-D5A2-279C-9E6B8690031891A8';
   			Ext.NS_2EDB6F3AD5A2279C9E6B8690031891A8.Data.getUserToolbars(qc, function(res) {
   				if (res.success) {
   					dis.addDocked(res);
   				}
   			});
   		...
   		gridRecordedSelected: function(dis, rec, ind) {
   			var formCmp = Ext.getCmp('viewform52BF304B-F632-0CBC-301B3EE59BAA3F32') || Ext.getCmp('autoeformididid');
   			if (formCmp) {
