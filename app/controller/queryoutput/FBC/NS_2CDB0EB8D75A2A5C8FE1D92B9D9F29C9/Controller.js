Ext.define('Form.controller.queryoutput.FBC.NS_2CDB0EB8D75A2A5C8FE1D92B9D9F29C9.Controller', {
   	extend: 'Ext.app.Controller',
   	views: ['queryoutput.FBC.NS_2CDB0EB8D75A2A5C8FE1D92B9D9F29C9.View'],
   	models: ['queryoutput.FBC.NS_2CDB0EB8D75A2A5C8FE1D92B9D9F29C9.Model'],
   	stores: ['queryoutput.FBC.NS_2CDB0EB8D75A2A5C8FE1D92B9D9F29C9.Store'],
   		init: function() {
   			this.control({
   				'panel': {
   					render: this.initPanel
   				},
   				'NS_2CDB0EB8D75A2A5C8FE1D92B9D9F29C9 button': {
   					click: this.topBarButtonClicked
   				},
   				'NS_2CDB0EB8D75A2A5C8FE1D92B9D9F29C9': {
			...
			topBarButtonClicked: function(b) {
	   		if (b.action) {
				...
				var dw = Ext.create('Ext.window.Window', {
				    ...
				    items: [{
				    	xtype: 'form',
				    	id: 'viewform2DA2FD5A-0054-53C7-FCCA46A8A088B3E5',
				    	autoScroll: true,
				    	items: [{
							width: '95%',name: 'glkschool-SCHOOLNAME',
							fieldLabel: 'School Name',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21education-LOCATION',
							fieldLabel: 'Location',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'glkcourse-DESCRIPTION',
							fieldLabel: 'Course',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'glkeduclevel-DESCRIPTION',
							fieldLabel: 'Educ Level',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'glkdegree-DESCRIPTION',
							fieldLabel: 'Degree',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21education-DATEBEGIN',
							fieldLabel: 'Date Begin',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21education-DATEFINISHED',
							fieldLabel: 'Date Finished',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21education-GRADUATE',
							fieldLabel: 'Is Graduate',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21education-SCHOLASTICSTANDING',
							fieldLabel: 'Scholastic Standing',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21education-HONORSRECEIVED',
							fieldLabel: 'Honors Received',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21education-GPA',
							fieldLabel: 'GPA',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21education-SCHOOLCODE',
							fieldLabel: 'School Code',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21education-COURSECODE',
							fieldLabel: 'Course Code',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21education-EDUCLEVEL',
							fieldLabel: 'Level Code',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21education-DEGREECODE',
				...
				var fwin = Ext.create('Ext.window.Window', {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
				    			var dgrid = Ext.widget('NS_2CDB0EB8D75A2A5C8FE1D92B9D9F29C9');
				...
				if (dgdata) df.setValues(dgdata.data);
	       		...
	       		Ext.Msg.show({
					...
					var qrytitle = 'Education';
					var qrycode = '2CDB0EB8-D75A-2A5C-8FE1D92B9D9F29C9';
					Ext.NS_2CDB0EB8D75A2A5C8FE1D92B9D9F29C9.Data.exportGridToExcel(qrycode, qrytitle, function(res) {
						dgrid.getEl().unmask();
						if (res.result !== true) {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
					    		...
					    		Ext.NS_2CDB0EB8D75A2A5C8FE1D92B9D9F29C9.Data.emailSelGridQuery(fromv,tov,subjectv,bodyv,function(res) {
					    			dwin.getEl().unmask();
					    			if (res.success !== true) {
   		...
   		gridRenderingComplete: function(dis, eopts) {
   			var qc = '2CDB0EB8-D75A-2A5C-8FE1D92B9D9F29C9';
   			Ext.NS_2CDB0EB8D75A2A5C8FE1D92B9D9F29C9.Data.getUserToolbars(qc, function(res) {
   				if (res.success) {
   					dis.addDocked(res);
   				}
   			});
   		...
   		gridRecordedSelected: function(dis, rec, ind) {
   			var formCmp = Ext.getCmp('viewform2DA2FD5A-0054-53C7-FCCA46A8A088B3E5') || Ext.getCmp('autoeformididid');
   			if (formCmp) {
