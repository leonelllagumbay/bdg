Ext.define('Form.controller.queryoutput.FBC.NS_2DEB4B28CB7237C3F68289B40A6B42F6.Controller', {
   	extend: 'Ext.app.Controller',
   	views: ['queryoutput.FBC.NS_2DEB4B28CB7237C3F68289B40A6B42F6.View'],
   	models: ['queryoutput.FBC.NS_2DEB4B28CB7237C3F68289B40A6B42F6.Model'],
   	stores: ['queryoutput.FBC.NS_2DEB4B28CB7237C3F68289B40A6B42F6.Store'],
   		init: function() {
   			this.control({
   				'panel': {
   					render: this.initPanel
   				},
   				'NS_2DEB4B28CB7237C3F68289B40A6B42F6 button': {
   					click: this.topBarButtonClicked
   				},
   				'NS_2DEB4B28CB7237C3F68289B40A6B42F6': {
			...
			topBarButtonClicked: function(b) {
	   		if (b.action) {
				...
				var dw = Ext.create('Ext.window.Window', {
				    ...
				    items: [{
				    	xtype: 'form',
				    	id: 'viewform2E44C8F5-0C2D-D6B8-AD20E851DFF8120F',
				    	autoScroll: true,
				    	items: [{
							width: '95%',name: 'cin21empawards-REWARDCODE',
							fieldLabel: 'Reward Code',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'clkmeasures-DESCRIPTION',
							fieldLabel: 'Measure Description',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'clkmeasures-POINTS',
							fieldLabel: 'Points',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21empawards-DATEAWARDED',
				...
				var fwin = Ext.create('Ext.window.Window', {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
				    			var dgrid = Ext.widget('NS_2DEB4B28CB7237C3F68289B40A6B42F6');
				...
				if (dgdata) df.setValues(dgdata.data);
	       		...
	       		Ext.Msg.show({
					...
					var qrytitle = 'Awards';
					var qrycode = '2DEB4B28-CB72-37C3-F68289B40A6B42F6';
					Ext.NS_2DEB4B28CB7237C3F68289B40A6B42F6.Data.exportGridToExcel(qrycode, qrytitle, function(res) {
						dgrid.getEl().unmask();
						if (res.result !== true) {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
					    		...
					    		Ext.NS_2DEB4B28CB7237C3F68289B40A6B42F6.Data.emailSelGridQuery(fromv,tov,subjectv,bodyv,function(res) {
					    			dwin.getEl().unmask();
					    			if (res.success !== true) {
   		...
   		gridRenderingComplete: function(dis, eopts) {
   			var qc = '2DEB4B28-CB72-37C3-F68289B40A6B42F6';
   			Ext.NS_2DEB4B28CB7237C3F68289B40A6B42F6.Data.getUserToolbars(qc, function(res) {
   				if (res.success) {
   					dis.addDocked(res);
   				}
   			});
   		...
   		gridRecordedSelected: function(dis, rec, ind) {
   			var formCmp = Ext.getCmp('viewform2E44C8F5-0C2D-D6B8-AD20E851DFF8120F') || Ext.getCmp('autoeformididid');
   			if (formCmp) {
