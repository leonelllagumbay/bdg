Ext.define('Form.controller.queryoutput.FBC.NS_48B2EBE0C7002A9E1FF596E5398F02A8.Controller', {
   	extend: 'Ext.app.Controller',
   	views: ['queryoutput.FBC.NS_48B2EBE0C7002A9E1FF596E5398F02A8.View'],
   	models: ['queryoutput.FBC.NS_48B2EBE0C7002A9E1FF596E5398F02A8.Model'],
   	stores: ['queryoutput.FBC.NS_48B2EBE0C7002A9E1FF596E5398F02A8.Store'],
   		init: function() {
   			this.control({
   				'panel': {
   					render: this.initPanel
   				},
   				'NS_48B2EBE0C7002A9E1FF596E5398F02A8 button': {
   					click: this.topBarButtonClicked
   				},
   				'NS_48B2EBE0C7002A9E1FF596E5398F02A8': {
			...
			topBarButtonClicked: function(b) {
	   		if (b.action) {
				...
				var dw = Ext.create('Ext.window.Window', {
				    ...
				    items: [{
				    	xtype: 'form',
				    	id: 'viewform1F99CC6F-FC0F-ACA0-F55A298A73A8CFA8',
				    	autoScroll: true,
				    	items: [{
							width: '95%',name: 'ecrgboard-BOARDCODE',
							fieldLabel: 'Requisition Number',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'ecrgboard-DESCRIPTION',
							fieldLabel: 'Position',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'ecrgboard-CONTENT',
							fieldLabel: 'ecrgboardCONTENT',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'ecrgboard-ENDDATE',
							fieldLabel: 'End Date',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'ecrgboard-DATELASTUPDATE',
							fieldLabel: 'ecrgboardDATELASTUPDATE',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						}]
				...
				var fwin = Ext.create('Ext.window.Window', {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
				    			var dgrid = Ext.widget('NS_48B2EBE0C7002A9E1FF596E5398F02A8');
				...
				if (dgdata) df.setValues(dgdata.data);
	       		...
	       		Ext.Msg.show({
					...
					var qrytitle = 'Careers';
					var qrycode = '48B2EBE0-C700-2A9E-1FF596E5398F02A8';
					Ext.NS_48B2EBE0C7002A9E1FF596E5398F02A8.Data.exportGridToExcel(qrycode, qrytitle, function(res) {
						dgrid.getEl().unmask();
						if (res.result !== true) {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
					    		...
					    		Ext.NS_48B2EBE0C7002A9E1FF596E5398F02A8.Data.emailSelGridQuery(fromv,tov,subjectv,bodyv,function(res) {
					    			dwin.getEl().unmask();
					    			if (res.success !== true) {
   		...
   		gridRenderingComplete: function(dis, eopts) {
   			var qc = '48B2EBE0-C700-2A9E-1FF596E5398F02A8';
   			Ext.NS_48B2EBE0C7002A9E1FF596E5398F02A8.Data.getUserToolbars(qc, function(res) {
   				if (res.success) {
   					dis.addDocked(res);
   				}
   			});
   		...
   		gridRecordedSelected: function(dis, rec, ind) {
   			var formCmp = Ext.getCmp('viewform1F99CC6F-FC0F-ACA0-F55A298A73A8CFA8') || Ext.getCmp('autoeformididid');
   			if (formCmp) {
