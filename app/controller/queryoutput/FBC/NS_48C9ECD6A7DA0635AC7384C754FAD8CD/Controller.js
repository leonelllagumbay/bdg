Ext.define('Form.controller.queryoutput.FBC.NS_48C9ECD6A7DA0635AC7384C754FAD8CD.Controller', {
   	extend: 'Ext.app.Controller',
   	views: ['queryoutput.FBC.NS_48C9ECD6A7DA0635AC7384C754FAD8CD.View'],
   	models: ['queryoutput.FBC.NS_48C9ECD6A7DA0635AC7384C754FAD8CD.Model'],
   	stores: ['queryoutput.FBC.NS_48C9ECD6A7DA0635AC7384C754FAD8CD.Store'],
   		init: function() {
   			this.control({
   				'panel': {
   					render: this.initPanel
   				},
   				'NS_48C9ECD6A7DA0635AC7384C754FAD8CD button': {
   					click: this.topBarButtonClicked
   				},
   				'NS_48C9ECD6A7DA0635AC7384C754FAD8CD': {
			...
			topBarButtonClicked: function(b) {
	   		if (b.action) {
				...
				var dw = Ext.create('Ext.window.Window', {
				    ...
				    items: [{
				    	xtype: 'form',
				    	id: 'viewform50AD40A9-0E5B-9449-5289E8DD4A7A62B3',
				    	autoScroll: true,
				    	items: [{
				...
				var fwin = Ext.create('Ext.window.Window', {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
				    			var dgrid = Ext.widget('NS_48C9ECD6A7DA0635AC7384C754FAD8CD');
				...
				if (dgdata) df.setValues(dgdata.data);
	       		...
	       		Ext.Msg.show({
					...
					var qrytitle = 'Grouping Summary';
					var qrycode = '48C9ECD6-A7DA-0635-AC7384C754FAD8CD';
					Ext.NS_48C9ECD6A7DA0635AC7384C754FAD8CD.Data.exportGridToExcel(qrycode, qrytitle, function(res) {
						dgrid.getEl().unmask();
						if (res.result !== true) {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
					    		...
					    		Ext.NS_48C9ECD6A7DA0635AC7384C754FAD8CD.Data.emailSelGridQuery(fromv,tov,subjectv,bodyv,function(res) {
					    			dwin.getEl().unmask();
					    			if (res.success !== true) {
   		...
   		gridRenderingComplete: function(dis, eopts) {
   			var qc = '48C9ECD6-A7DA-0635-AC7384C754FAD8CD';
   			Ext.NS_48C9ECD6A7DA0635AC7384C754FAD8CD.Data.getUserToolbars(qc, function(res) {
   				if (res.success) {
   					dis.addDocked(res);
   				}
   			});
   		...
   		gridRecordedSelected: function(dis, rec, ind) {
   			var formCmp = Ext.getCmp('viewform50AD40A9-0E5B-9449-5289E8DD4A7A62B3') || Ext.getCmp('autoeformididid');
   			if (formCmp) {
