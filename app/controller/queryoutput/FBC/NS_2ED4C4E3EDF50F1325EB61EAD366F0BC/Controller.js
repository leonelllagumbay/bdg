Ext.define('Form.controller.queryoutput.FBC.NS_2ED4C4E3EDF50F1325EB61EAD366F0BC.Controller', {
   	extend: 'Ext.app.Controller',
   	views: ['queryoutput.FBC.NS_2ED4C4E3EDF50F1325EB61EAD366F0BC.View'],
   	models: ['queryoutput.FBC.NS_2ED4C4E3EDF50F1325EB61EAD366F0BC.Model'],
   	stores: ['queryoutput.FBC.NS_2ED4C4E3EDF50F1325EB61EAD366F0BC.Store'],
   		init: function() {
   			this.control({
   				'panel': {
   					render: this.initPanel
   				},
   				'NS_2ED4C4E3EDF50F1325EB61EAD366F0BC button': {
   					click: this.topBarButtonClicked
   				},
   				'NS_2ED4C4E3EDF50F1325EB61EAD366F0BC': {
			...
			topBarButtonClicked: function(b) {
	   		if (b.action) {
				...
				var dw = Ext.create('Ext.window.Window', {
				    ...
				    items: [{
				    	xtype: 'form',
				    	id: 'viewform529E9F73-C884-FC80-5D863ECAF28D35A9',
				    	autoScroll: true,
				    	items: [{
							width: '95%',name: 'cin21relative-NAME',
							fieldLabel: 'Name',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21relative-RELATIONSHIP',
							fieldLabel: 'Relationship',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21relative-COMPANY',
							fieldLabel: 'Company',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21relative-POSITION',
							fieldLabel: 'Position',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						},{
							width: '95%',name: 'cin21relative-DEPARTMENTAREAD',
							fieldLabel: 'Department Area',
							padding: 10,
						 	labelAlign: 'top',
						 	xtype: 'displayfield'
						}]
				...
				var fwin = Ext.create('Ext.window.Window', {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
				    			var dgrid = Ext.widget('NS_2ED4C4E3EDF50F1325EB61EAD366F0BC');
				...
				if (dgdata) df.setValues(dgdata.data);
	       		...
	       		Ext.Msg.show({
					...
					var qrytitle = 'Relatives (inside company)';
					var qrycode = '2ED4C4E3-EDF5-0F13-25EB61EAD366F0BC';
					Ext.NS_2ED4C4E3EDF50F1325EB61EAD366F0BC.Data.exportGridToExcel(qrycode, qrytitle, function(res) {
						dgrid.getEl().unmask();
						if (res.result !== true) {
				    ...
				    buttons: [{
				    	...
				    	handler: function(em) {
				    		...
				    		if (dform.isValid()) {
					    		...
					    		Ext.NS_2ED4C4E3EDF50F1325EB61EAD366F0BC.Data.emailSelGridQuery(fromv,tov,subjectv,bodyv,function(res) {
					    			dwin.getEl().unmask();
					    			if (res.success !== true) {
   		...
   		gridRenderingComplete: function(dis, eopts) {
   			var qc = '2ED4C4E3-EDF5-0F13-25EB61EAD366F0BC';
   			Ext.NS_2ED4C4E3EDF50F1325EB61EAD366F0BC.Data.getUserToolbars(qc, function(res) {
   				if (res.success) {
   					dis.addDocked(res);
   				}
   			});
   		...
   		gridRecordedSelected: function(dis, rec, ind) {
   			var formCmp = Ext.getCmp('viewform529E9F73-C884-FC80-5D863ECAF28D35A9') || Ext.getCmp('autoeformididid');
   			if (formCmp) {
