Ext.define('Form.view.form.defColumnDetailsView', { 
	...
	initComponent: function() {   
		...
		this.items = [{
				...
				labelWidth: 200, 
				width: 200,
				value: '<p>{RANDOM} - Random Characters</p><p>{NUMBER} - e.i; 00{NUMBER} may generate 01, 45, or 23. Supports up to 10 digits.</p><p>{DATE} or {TIME} - Current date or time. Format: YYYYMMDD or HHMMSS</p><p>{DATEFORMAT} or {TIMEFORMAT} - Current formatted date or time. Other CF date & time format are supported, (ex. {d},{mmmm},etc).</p><p>{UUID} - Universally Unique Identifier (UUID). A UUID is a 35-character string representation of a unique 128-bit integer.</p><p>{step=N seed=M format=00000} autoincrement field.</p>'
		    },{
		...
		// configs for BasicForm
		 this.api = {
				        ...
				        // The server-side must mark the submit handler as a 'ExtFormHandler'
