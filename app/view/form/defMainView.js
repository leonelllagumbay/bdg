	...
	initComponent: function() {    
		...
		this.columns =  [{
			...
			width: 100
		  	...
		  	text: 'Audit Trail Data Source',
			dataIndex: 'AUDITTDSOURCE',
			filterable: true,
			editor: 'textfield',
			width: 200
		  },{
		  	text: 'Audit Trail Table Name',
			dataIndex: 'AUDITTNAME',
			filterable: true,
			editor: 'textfield',
			width: 200
		  },{
			...
			width: 200
		  	...
		  	text: 'Log Data Source',
			dataIndex: 'LOGDBSOURCE',
			filterable: true,
			editor: 'textfield',
			width: 200
		  },{
		  	text: 'Log Table Name',
			dataIndex: 'LOGTABLENAME',
			filterable: true,
			editor: 'textfield',
			width: 200
		  },{
			...
			width: 250
		  	...
		  	text: 'Before eForm Removal',
			dataIndex: 'ONBEFOREDELETE',
			filterable: true,
			editor: {
				xtype: 'combobox',
				store: 'form.oncompletestore',
			...
			width: 250
		  	...
		  	text: 'After eForm Removal',
			dataIndex: 'ONAFTERDELETE',
			filterable: true,
			editor: {
				xtype: 'combobox',
				store: 'form.oncompletestore',
			...
			width: 250
		  	...
		  	text: 'Before Routing eForm',
			dataIndex: 'ONBEFOREROUTE',
			filterable: true,
			editor: {
				xtype: 'combobox',
				store: 'form.oncompletestore',
			...
			width: 250
		  	...
		  	text: 'After Routing eForm',
			dataIndex: 'ONAFTERROUTE',
			filterable: true,
			editor: {
				xtype: 'combobox',
				store: 'form.oncompletestore',
