Ext.define('Form.view.queryoutput.FBC.NS_387B5E33B26001E52294FBB5C3F16A19.View', {
    ...
    columns: [{
		...
		sortable: true,
		width: 400,
		renderer: function renderTopic(value, p, record) {      	var dcontent = record.data['egintestquery-S2']; 	 	return Ext.String.format('<strong><a href="' + dcontent + '" target="_blank">{0}</a></strong>',value);  },
