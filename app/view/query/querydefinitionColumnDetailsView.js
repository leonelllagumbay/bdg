		...
		this.items = [{
			...
			items: [{
			    ...
			    items: [{
			    	...
			    	boxLabel: 'Check',
			    	name: 'OUTPUTTYPE',
				    inputValue: 'checkcolumn'
			    },{
			    	boxLabel: 'Row Numberer',
			    	name: 'OUTPUTTYPE',
				    inputValue: 'rownumberer'
			    },{
			    	boxLabel: 'Action Column',
			    	name: 'OUTPUTTYPE',
				    inputValue: 'actioncolumn'
			    },{
			    	boxLabel: 'Template Column',
			    	name: 'OUTPUTTYPE',
				    inputValue: 'templatecolumn'
			    }]   
			},{
				fieldLabel: 'Column Group',
				name: 'COLUMNGROUP',
				maxLength: 100
		    },{
				fieldLabel: 'Align',
				...
				listeners: {
			        afterrender: function(cmp) {
			            cmp.getEl().set({
			                "title": "Override the column name alias of the query. The header text to be used as innerHTML (html tags are accepted) to display in the Grid. Note: to have a clickable header with no text displayed you can use the default of &#160; aka &nbsp;.\n\nDefaults to: '&#160;'"
			            });
			        }
			    }
			},{
				...
				maxLength: 250,
				queryMode: 'local',
				store: 'query.summarytype', 
				displayField: 'summarytypename',
				valueField: 'summarytypecode',
				width: 500,
				listeners: {
			        afterrender: function(cmp) {
			            cmp.getEl().set({
			                "title": "The summary value needs to be calculated for each column in the grid. This is controlled by the summaryType option specified on the column. There are several built in summary types, which can be specified as a string on the column configuration.\n\nAlternatively, the summaryType can be a function definition. If this is the case, the function is called with an array of records to calculate the summary value."
			            });
			        }
			    }
			}]
			...
			items: [{ 
				...
				fieldLabel: 'Enable group header',
				xtype: 'combobox',
				queryMode: 'local',
				store: 'query.yesno', 
				displayField: 'yesnoname',
				...
				listeners: {
			        afterrender: function(cmp) {
			            cmp.getEl().set({
			                "title": "Use the column group name as the group header. Default value: true"
			            });
			        }
			    }
			},{
			...
			items: [{
				...
				xtype: 'textareafield',
				fieldLabel: 'Summary Renderer',
				maxLength: 2500,
				listeners: {
			        afterrender: function(cmp) {
			            cmp.getEl().set({
			                "title": "Similar to a column, the summary also supports a summaryRenderer function. This summaryRenderer is called before displaying a value. The function is optional, if not specified the default calculated value is shown. The summaryRenderer is called with:\n\n-value {Object} - The calculated value.\n-summaryData {Object} - Contains all raw summary values for the row.\n-field {String} - The name of the field we are calculating"
			            });
			        }
			    }
			},{
