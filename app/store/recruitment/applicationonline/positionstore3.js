Ext.define('OnlineApplication.store.recruitment.applicationonline.positionstore3', {
	...
	listeners: {
		beforeload: function(b) {
			var fcompanycode = Ext.ComponentQuery.query("employmentinfoview combobox[name=COMPANYTHIRDPRIORITY]")[0].getValue();
